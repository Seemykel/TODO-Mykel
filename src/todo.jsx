        ...
        <section className='todoapp'>
            <div className='overlay'>
                <div className='todo-list'>
                    <p className={`modal ${showModal.show ? 'show' : ''}`}>{showModal.content}</p>
                    <h1>Note App</h1>
                    {
                        showTextArea ? 
                            <form onSubmit={handleTaskSubmit} className='list'>
                                <input type="text" value={singleTask} onChange={(e)=>setSingleTask(e.target.value)} placeholder='Input Your Task Here'/>
                                <input type="submit" value="Add" />
                            </form> : 
                            <div className='add-btn'>
                                <button onClick={()=> setShowTextArea(true)} className='add'><FaPlus /></button>
                            </div>
                    }
                </div>
                <div className='task'>
                                        ...
                                        return(
                                            <li key={task.id}>
                                                ...
                                                <div className='icons'>
                                                    ...
                                                    <span><button onClick={() => handleEdit(task.id)}><FaEdit /></button></span>
